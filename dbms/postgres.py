...
class PgDBMS(DBMSTemplate):
    ...
    def _connect(self, db=None):
        ...
        while True:
            try:            
                ...
                self.failed_times += 1
                logger.warning(f'Exception while trying to connect: {e}')
                if self.failed_times >= 4:
                    self.recover_dbms()
                    return False
                logger.info("Reconnet again")
                time.sleep(3)
    ...
    def reconfigure(self):
        ...
        if success:
            ...
            try:
                ...
                logger.warning(f'Exception while trying to recover dbms: {e}')
                return False
    ...
    def write_to_reset_knob_config_and_check(self, cnf_file, target_knobs, config):
        # TODO: Implement the function to calculate factorial
        pass
